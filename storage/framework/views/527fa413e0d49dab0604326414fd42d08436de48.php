...
<div class="container">
    ...
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="nav-img1" role="tabpanel" aria-labelledby="nav-img1-tab">
        <form method="post" action="<?php echo e(route('production.store')); ?>" enctype="multipart/form-data"><?php echo csrf_field(); ?>
        <div class="form-row">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <option value="<?php echo e($c->name); ?>" selected><?php echo e($c->name); ?></option><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\product\resources\views\home\production\create.blade.php ENDPATH**/ ?>