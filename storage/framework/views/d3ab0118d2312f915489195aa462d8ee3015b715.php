...
<div class="card-header"><?php echo e($profile->name); ?></div>
	...
	<div class="col-xl-12" style="text-align:center;">
		<!--follo-->
	<form action="<?php echo e(route('profile.like')); ?>" method="post"><?php echo csrf_field(); ?>
	<input type="hidden" name="profiles_like" value="<?php echo e($profile->id); ?>">
		<button class="btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Click to follow" type="submit"><?php echo e($likers); ?> Likes</button>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\product\resources\views\home\profile\show.blade.php ENDPATH**/ ?>