...
<html lang="en" data-textdirection="ltr" class="loading">
  <head>
    ...
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/css/bootstrap.css')); ?>">
    <!-- font icons-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/fonts/icomoon.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/fonts/flag-icon-css/css/flag-icon.min.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/css/extensions/pace.css')); ?>">
    <!-- END VENDOR CSS-->
    <!-- BEGIN ROBUST CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/css/bootstrap-extended.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/css/app.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/css/colors.css')); ?>">
    <!-- END ROBUST CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/css/core/menu/menu-types/vertical-menu.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/css/core/menu/menu-types/vertical-overlay-menu.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/app-assets/css/core/colors/palette-gradient.css')); ?>">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('/css/responsive.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('vendor/robust/themes/robust/assets/css/style.css')); ?>">
    <!-- END Custom CSS-->
...
<div class="row match-height">
    ...
    <!-- BEGIN VENDOR JS-->
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/js/core/libraries/jquery.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/ui/tether.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/js/core/libraries/bootstrap.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/ui/perfect-scrollbar.jquery.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/ui/unison.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/ui/blockUI.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/ui/jquery.matchHeight-min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/ui/screenfull.min.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/extensions/pace.min.js')); ?>" type="text/javascript"></script>
    <!-- BEGIN VENDOR JS-->
    <!-- BEGIN PAGE VENDOR JS-->
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/vendors/js/charts/chart.min.js')); ?>" type="text/javascript"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN ROBUST JS-->
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/js/core/app-menu.js')); ?>" type="text/javascript"></script>
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/js/core/app.js')); ?>" type="text/javascript"></script>
    <!-- END ROBUST JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="<?php echo e(asset('vendor/robust/themes/robust/app-assets/js/scripts/pages/dashboard-lite.js')); ?>" type="text/javascript"></script>
    <!-- END PAGE LEVEL JS-->
    <?php echo $__env->yieldContent('js'); ?>
  </body>
</html>
<?php /**PATH C:\wamp64\www\product2\resources\views/templates.blade.php ENDPATH**/ ?>