...
<div class="col-xl-5 float-left card" style="border-radius: 0;box-shadow:none;">
  ...
  <div class="mySlides">
    <div class="numbertext">1 / 5</div>
      <img src="<?php echo e($production->main_pictures); ?>" class="item-img">
  </div>
<?php if($production->second_pictures == true): ?>
  <div class="mySlides">
    <div class="numbertext">2 / 5</div>
      <img src="<?php echo e($production->second_pictures); ?>" class="item-img">
  </div>
<?php endif; ?>
<?php if($production->three_pictures == true): ?>
  <div class="mySlides">
    <div class="numbertext">3 / 5</div>
      <img src="<?php echo e($production->three_pictures); ?>" class="item-img">
  </div>
<?php endif; ?>
<?php if($production->fourth_pictures == true): ?>
  <div class="mySlides">
    <div class="numbertext">4 / 5</div>
      <img src="<?php echo e($production->fourth_pictures); ?>" class="item-img">
  </div>
<?php endif; ?>
<?php if($production->five_pictures == true): ?>
  <div class="mySlides">
    <div class="numbertext">5 / 5</div>
      <img src="<?php echo e($production->five_pictures); ?>" class="item-img">
  </div>
<?php endif; ?>
  ...
  <div class="row" style="width: 500px;">
    <div class="column">
      <img class="demo cursor" src="<?php echo e($production->main_pictures); ?>" style="width:100%" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <?php if($production->second_pictures == true): ?>
    <div class="column">
      <img class="demo cursor" src="<?php echo e($production->second_pictures); ?>" style="width:100%" onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <?php endif; ?>
    <?php if($production->three_pictures == true): ?>
    <div class="column">
      <img class="demo cursor" src="<?php echo e($production->three_pictures); ?>" style="width:100%" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
    <?php endif; ?>
    <?php if($production->fourth_pictures == true): ?>
    <div class="column">
      <img class="demo cursor" src="<?php echo e($production->fourth_pictures); ?>" style="width:100%" onclick="currentSlide(4)" alt="Northern Lights">
    </div>
    <?php endif; ?>
    <?php if($production->five_pictures == true): ?>
    <div class="column">
      <img class="demo cursor" src="<?php echo e($production->five_pictures); ?>" style="width:100%" onclick="currentSlide(5)" alt="Nature and sunrise">
    </div>
    <?php endif; ?>
  </div>
  </div>
  <div class="col-xl-7 float-left card" style="border-radius: 0;box-shadow:none;">
    <p style="font-weight: bolder;font-size: 17px;padding-top: 10px;"><?php echo e(base64_decode($production->name_products)); ?></p>
    <div style="width: 100%;padding-left: 10px;background-color: #dedede;">
    <p style="color: #d0011b;font-weight: bolder;font-size: 24px;padding-top: 10px;">Rp. <?php echo e($production->price); ?></p>
  </div>
  ...
  <p><span style="padding-right: 20px;color: #757575;">Delivery</span> <i class="fas fa-shipping-fast" style="padding-right: 2px;
    ...
    <form method="POST" action="<?php echo e(route('productions.buy', $production->id)); ?>"><?php echo csrf_field(); ?>
  <p><span style="padding-right: 20px;color: #757575;">Amount</span> 
    <input type="number" name="remaining" class="form-control col-xl-3" min="1" max="<?php echo e($production->remaining_products); ?>" maxlength="<?php echo e($production->remaining_products); ?>" style="display: inline;"> <span style="padding-left: 10px;">remaining <?php echo e($production->remaining_products); ?> units</span>
  </p>
  <input type="hidden"name="add" value="<?php echo e($production->id); ?>">
<input type="hidden" name="prices" value="<?php echo e($production->price); ?>">

<input type="hidden" name="buy_products" value="<?php echo e($production->id); ?>">
          <input type="hidden" name="price" value="<?php echo e($production->price); ?>">
          <input type="hidden" name="stock" value="<?php echo e($production->remaining_products); ?>">
...
<div class="col-xl-12 card" style="margin-top: 17px;">
  <div class="card-header" style="text-decoration: underline;font-family: 'Pangolin', cursive;font-size: 20px;font-weight: bolder;background-color: white;padding: 10px;">Descriptions Products</div>
    <p style="font-family: 'Cuprum-Regular';"><?php echo Crypt::decrypt($production->description_products); ?></p>
    <div class="dropdown-divider"></div>
...
<div class="col-xl-12 bg-info float-left" style="margin-top: 10px;">
      ...
      <form action="<?php echo e(route('productions.question')); ?>" method="POST" enctype="multipart/form-data"><?php echo csrf_field(); ?>
        ...
        <input class="form-control" type="hidden" name="production_id" value="<?php echo e($production->id); ?>">
    ...
    height: 80px;"></textarea>
      ...
      <div class="card-body no-padding">
        <?php $__currentLoopData = $production->question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-xl-12 float-left" style="font-family: 'Cuprum-Bold';margin-top:10px;" id="productsid<?php echo e($production->id); ?>">
        ...
        <i class="far fa-star stars-color"></i>
        <i class="far fa-star stars-color"></i>
        <i class="far fa-star stars-color"></i><?php endif; ?>
        <?php if($q->star == '2'): ?>
        <i class="fas fa-star stars-color"></i>
        <i class="fas fa-star stars-color"></i>
        <i class="far fa-star stars-color"></i>
        ...
        <i class="fas fa-star stars-color"></i>
        <i class="fas fa-star stars-color"></i>
        <i class="fas fa-star stars-color"></i><?php endif; ?>
      
        <span class="float-right"><?php echo e($q->created_at); ?></span>
      
        <div style="text-align: center;">
          <p class="text-comment"><?php echo e($q->comment); ?></p>
          <?php if($q->img == true): ?>
          <p style="text-align: left;" class="img-comment"><img src="<?php echo e($q->img); ?>" style="width: 50px;"><img src="<?php echo e($q->img); ?>" class="img-blocks"></p>
      <?php endif; ?>
      <?php if($production->user_id == auth()->user()->id): ?>
            <form method="post" action="<?php echo e(route('productions.delete', $q->id)); ?>"><?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
          <p class="help" style="text-align: left;">
          <i class="far fa-thumbs-up" data-target="#like<?php echo e($q->id); ?>" data-toggle="modal"><?php
...
<?php $__currentLoopData = $production->question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<!-- Modal -->
<div class="modal fade" id="like<?php echo e($q->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
  <div class="modal-content">
  <div class="modal-body" style="text-align: center;">
  Do you want like comment ?
  <form action="<?php echo e(route('productions.likequestion')); ?>" method="post"><?php echo csrf_field(); ?>
  <input type="hidden" value="<?php echo e($q->id); ?>" name="question">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\product\resources\views\home\production\show.blade.php ENDPATH**/ ?>