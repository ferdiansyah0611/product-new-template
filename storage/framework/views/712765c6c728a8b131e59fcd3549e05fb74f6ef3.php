        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
              <a href="<?php echo e(route('setting.history')); ?>" class="nav-link left-icon">
...
<?php if(auth()->guard()->check()): ?>
  ...
  <?php endif; ?><?php /**PATH C:\wamp64\www\product2\resources\views/layouts/templateAside.blade.php ENDPATH**/ ?>