...
<div class="modal-body">
  ...
  <div class="modal fade" id="update<?php echo e($p->id); ?>" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true">
    ...
    <div class="ajax"></div>
    <div style="display: flex;justify-content: center;"><?php echo e($for->links()); ?></div>
</div>
</div>
<?php $__env->stopSection(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\product\resources\views\home\dashboard\manage_users.blade.php ENDPATH**/ ?>