            ...
            <div class="card-body">
                <div class="media">
                    ...
                    <div class="p-2 bg-deep-orange white media-body">
                        <h5>New Users</h5><h5 id="countUser"></h5>
...
<div class="row">
  ...
  <div class="col-xl-4 col-md-12 col-sm-12">
    ...
    <div class="card-body">
      ...
      <p id="notif_delete{{$notif->id}}" style="font-size:10px;margin-top:-10px;padding-left: 30px;" class="col-xl-12">{{$notif->notification}}. {{$notif->created_at->diffForHumans()}} 
      <button class="btn-danger" onclick="document.getElementById('notif_delete{{$notif->id}}').style.display = 'none';">
        <i class="fas fa-trash"></i>
      </button></p>
      @endforeach
      <form id="formNotifDelete" style="margin-left: 30px;">@csrf
          <p><button class="btn btn-danger" id="deleteNotification">Delete All</button>
