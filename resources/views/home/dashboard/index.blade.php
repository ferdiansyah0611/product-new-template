...
<div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">{{$likers}}</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
<div class="row col-xl-12">
  ...
  <div class="card bg-gradient-info font-12">
      ...
      <div class="card-footer bg-transparent">
        <form method="post" action="{{route('dashboard.newcategory')}}">@csrf
                  ...
                  <div class="card-body p-0">
                    <ul class="users-list clearfix">
                      ...
                      <li>
                        ...
                        <img class="col-xl-3" src="{{asset($user->avatars)}}" alt="User Image" style="height: 114px;">
                        @endif
                        @if($user->avatars == null)
                        <img class="col-xl-3" src="{{asset('user-default.png')}}" alt="User Image" style="height: 114px;">
                        @endif
  ...
  <div class="col-md-6">
    <div class="card bg-gradient-primary">
          ...
          <p id="notif_delete{{$notif->id}}" style="font-size:12px;margin-top:-10px;">{{$notif->notification}}. {{$notif->created_at->diffForHumans()}} 
          ...
          @endforeach
          <form action="{{route('dashboard.deleteallnotification')}}" method="POST">@csrf @method('DELETE')
              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table m-0">
                    ...
                    <tr>
                      <td><a href="pages/examples/invoice.html">{{$purchase->purchase_id}}</a></td>
                      <td>
                        <?php
                        ...
                        ?>
                        {{base64_decode($purchase->name_products)}}</td>
                      <td>
                      ...
                      <td>
                        <div class="sparkbar" data-color="#00a65a" data-height="20">{{$purchase->locate}}</div>
                      </td>
                    </tr>
                    @endforeach
                    </tbody>
    ...
    <div class="card-body p-0">
      ...
      <li class="item">
        <div class="product-img">
          <img src="{{asset($recent->main_pictures)}}" alt="Product Image" class="img-size-50">
        </div>
