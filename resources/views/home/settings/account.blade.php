...
<img class="card-img-top mx-auto" src="{{asset($profile->avatars)}}" alt="" style="border-radius: 50%;height: 230px;width:60%;">
    @endif
    <div class="card-body">
    ...
    <div class="form-group col-xl-6 float-right">
            <input class="form-control" placeholder="name" type="text" name="name" value="{{$profile->name}}">
            <input class="form-control" placeholder="email" type="text" name="email" value="{{$profile->email}}">
            ...
            <input value="{{$profile->identity_card}}" class="form-control" placeholder="identity_card" type="number" name="identity_card">
            <input value="{{$profile->debit_card}}" class="form-control" placeholder="debit_card" type="number" name="debit_card">
        <input value="{{$profile->number}}" class="form-control" placeholder="number" type="number" name="number">
        <input value="{{$profile->born}}" class="form-control" placeholder="hbd" type="date" name="born">
        <input value="{{$profile->description}}" class="form-control" placeholder="description" type="text" name="description" maxlength="255">
        <input value="{{$profile->locate}}" class="form-control" placeholder="locate" type="text" name="locate">
