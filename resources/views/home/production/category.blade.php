            ...
            <div class="card-body custom-body-card">
              ...
              <div class="col-xl-3 float-left">
                <div class="wow fadeInDown float-left hover-style" style="animation-duration: 1s;">
                  <a class="title-col-xl-3"  href="{{url('/productions/views', $c->title)}}">{{base64_decode($c->name_products)}}</a>
                  ...
                  <div class="card-footer custom-card-footer">
                    ...
                    <p class="left"><i class="icon-cart4" class="icon-15"></i> {{$c->remaining_products}} units</p>
                    <button class="btn btn-primary" style="font-size: 12px;" data-toggle="tooltip" data-placement="bottom" title="Buy Now">Price ${{$c->price}}</button>
                    <button class="btn btn-danger font-12" data-toggle="tooltip" data-placement="bottom" title="Click to add cart">Add Cart</button>
                  </div>
                </div>
              </div>
              @endforeach
