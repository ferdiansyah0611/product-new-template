            ...
            <div class="card-header">
                    ...
                    <div class="modal-dialog modal-dialog-scrollable|modal-dialog-centered modal-sm" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="newFilesTitle">Upload video</h5>
                            </div>
                            <form method="post" action="{{route('file.uploadfile')}}" enctype="multipart/form-data">@csrf
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" name="video" accept=".mp4,.3gp,.mkv,.avi,.mpeg">
                ...
                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                    ...
                    $('#refreshFileManager').click(function(){
                        $('#FileManager').load("{{url('/files/component/filevideoID')}}");
