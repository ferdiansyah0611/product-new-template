...
processing: true,
serverSide: true,
ajax: "{{route('apiget.admin_usersManage')}}",
columns: [
{ data: 'id', name: 'id' },
{ data: 'name', name: 'name' },
...
$.get("{{url('/dashboards/user')}}"+'/'+user_id+'/edit', function(data){
...
e.preventDefault();
$.ajax({
url:"{{route('dashboard.update_user')}}",
type: 'post',
...
var user_id = $(this).data('id');
$.ajax({
url:"{{url('/dashboards/user/delete')}}"+'/'+user_id,
type: 'post',
success:function()
{
tabel.draw();
