...
<div class="card">
    <div class="card-header">
        <a href="{{url('/')}}"><?php echo $_SERVER['SERVER_NAME'];?></a> <i class="icon-ios-arrow-right"></i> <a href="{{route('productions.index')}}">productions</a> <i class="icon-ios-arrow-right"></i> manage
    </div>
</div>
<div class="card col-xl-12 expandID">
    <div class="card-header">
        <h5 class="card-title">Management Item Products</h5>
